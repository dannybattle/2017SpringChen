...
class Player(object):
    ...
    def __init__(self, name=None, rolls=6, target_score = 100):
...
players = [Player('Bob', 4, 100), Player('Sue', 4, 100), Player('Dax', 4, 100), Player('Ann', 4, 100)]
...
for winner, wins in Winners.items():
    print(winner, len(wins), float(len(wins)) / 5000)
